  ...
  return (
    <AssistantModalPrimitive.Root>
      ...
      <AssistantModalPrimitive.Content
        sideOffset={16}
        className="chatbot-scope bg-[var(--popover)] text-[var(--popover-foreground)] z-50 h-[500px] w-[450px] overflow-clip rounded-xl border shadow-md outline-none [&>.aui-thread-root]:bg-[var(--background)] data-[state=closed]:animate-out data-[state=open]:animate-in data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out data-[state=open]:zoom-in data-[state=open]:slide-in-from-bottom-1/2 data-[state=open]:slide-in-from-right-1/2 data-[state=closed]:slide-out-to-bottom-1/2 data-[state=closed]:slide-out-to-right-1/2"
      >
        <Thread />
      </AssistantModalPrimitive.Content>
    </AssistantModalPrimitive.Root>
